...
def solver(funktion: str = None, a: float = None, b: float = None, epsilon: float = None) -> Tuple[float, int]:
    """Führt das Bisektionsverfahren aus, es kann entweder mit eingabe oder mit übergebenen werten arbeiten.
